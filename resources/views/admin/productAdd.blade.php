...
<head>
  ...
  <title>{{ config('app.name','The Agric Store') }}</title>
          ...
          <div class="col-lg-6">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <!-- Administrator Forms -->
                  <form class="form-validate form-horizontal" method="post" action="{{ route('admin.product.add') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    <div class="form-group ">
                      <label for="product_name" class="control-label col-lg-2">Product Name <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input name="product_name" type="text" class="form-control @error('product_name') is-invalid @enderror" required/>
                          @error('product_name')
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input name="price" type="text" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" required/>
                          @error('price')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group ">
                      <label for="category" class="control-label col-lg-2">Product Category<span class="required">*</span></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      <label for="weight" class="control-label col-lg-2">Weight<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input name="weight" type="weight" class="form-control @error('weight') is-invalid @enderror" required />
                          @error('weight')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group ">
                      <label for="discount" class="control-label col-lg-2">Product Discount<span class="required">*</span></label>
                      <div class="col-lg-10">
                     ...
                     <div class="form-group ">
                      <label for="photo" class="control-label col-lg-2">Product Photo <span class="required">*</span></label>
                      <div class="col-lg-10">
