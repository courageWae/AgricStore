            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  ...
                  <!-- Administrator Forms -->
                  <form class="form-validate form-horizontal" method="post" action="{{ route('admin.update.project',['product' => $product->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group ">
                      <label for="product_name" class="control-label col-lg-2"><strong>Product Name</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('product_name') is-invalid @enderror" name="product_name" type="text" value="{{ $product->product_name }}" required/>
                          @error('product_name')
                    ...
                    <div class="form-group ">
                      <label for="price" class="control-label col-lg-2"><strong>Product Price</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('price') is-invalid @enderror" name="price" type="text" value="{{ $product->price }}" required/>
                        @error('price')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group ">
                      <label for="discount" class="control-label col-lg-2"><strong>Prodcut Discount</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('discount') is-invalid @enderror" name="discount" type="text" value="{{ $product->discount }}"/>
                        @error('discount')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group ">
                      <label for="category" class="control-label col-lg-2"><strong>Product Category</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('category') is-invalid @enderror" name="category" type="text" value="{{ $product->category->name }}" required/>
                        @error('category')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group ">
                      <label for="weight" class="control-label col-lg-2"><strong>Product Weight</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('weight') is-invalid @enderror" name="weight" type="text" value="{{ $product->weight }}" required/>
                        @error('weight')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group ">
                      <label for="photo" class="control-label col-lg-2"><strong>Product Photo</strong></label>
                      <div class="col-lg-10">
