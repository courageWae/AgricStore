...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="{{ route('home') }}"><b>T<br>H<br>E</b>Agric Store<span>The Best Agric Online Market</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" ><span>Equipments</span></a>
							</li>
							<li class="dropdown">
				...
				<div class=" con-w3l">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
										<img src="{{ asset('assets/images/of16.png') }}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
								...
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="0.80" data-quantity="1" data-image="{{ asset('assets/images/of19.png') }}">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
...
<!-- //for bootstrap working -->
<script type='text/javascript' src="{{ asset('assets/js/jquery.mycart.js') }}"></script>
  <script type="text/javascript">
  $(function () {
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of17.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of18.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of20.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
									<h3>Clips(1 pack)</h3>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of21.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
									<h3>Conditioner</h3>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of22.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								<div class="col-md-5 span-2">
											<div class="item">
												<img src="{{ asset('assets/images/of23.png') }}" class="img-responsive" alt="">
											</div>
								</div>
								<div class="col-md-7 span-1 ">
									<h3>Gel(150 g)</h3>
